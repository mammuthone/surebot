...
async function runAdbCommands() {
    try {
        ...
        await execPromise(`"${ADB_PATH}" shell monkey -p it.betway 1`);
        ...
        // LOGIN
        await execPromise(`"${ADB_PATH}" shell input tap 950 150`);
        await new Promise(resolve => setTimeout(resolve, 1000));


        //TAP username
        await execPromise(`"${ADB_PATH}" shell input tap 210 500`);
        await new Promise(resolve => setTimeout(resolve, 1000));
        await execPromise(`"${ADB_PATH}" shell input text m`);
        await execPromise(`"${ADB_PATH}" shell input text a`);
        await execPromise(`"${ADB_PATH}" shell input text m`);
        await execPromise(`"${ADB_PATH}" shell input text m`);
        await execPromise(`"${ADB_PATH}" shell input text u`);
        await execPromise(`"${ADB_PATH}" shell input text t`);
        await execPromise(`"${ADB_PATH}" shell input text h`);
        await execPromise(`"${ADB_PATH}" shell input text o`);
        await execPromise(`"${ADB_PATH}" shell input text n`);
        await execPromise(`"${ADB_PATH}" shell input text e`);


        //TAP password
        await execPromise(`"${ADB_PATH}" shell input tap 230 650`);
        await new Promise(resolve => setTimeout(resolve, 1000));
        await execPromise(`"${ADB_PATH}" shell input text 8`);
        await execPromise(`"${ADB_PATH}" shell input text 9`);
        await execPromise(`"${ADB_PATH}" shell input text s`);
        await execPromise(`"${ADB_PATH}" shell input text u`);
        await execPromise(`"${ADB_PATH}" shell input text m`);
        await execPromise(`"${ADB_PATH}" shell input text e`);
        await execPromise(`"${ADB_PATH}" shell input text l`);
        await execPromise(`"${ADB_PATH}" shell input text l`);
        await execPromise(`"${ADB_PATH}" shell input text U`);
        await execPromise(`"${ADB_PATH}" shell input text !`);
        await execPromise(`"${ADB_PATH}" shell input text !`);
        await execPromise(`"${ADB_PATH}" shell input keyevent 66`);
        await new Promise(resolve => setTimeout(resolve, 5000));

        // CLICCO LA RICERCA
        await execPromise(`"${ADB_PATH}" shell input tap 1010 250`);
        await new Promise(resolve => setTimeout(resolve, 1000));
